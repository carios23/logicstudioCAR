...
namespace Solucion_CAR.Controllers
{
    public class DetallesController : Controller
    {
        ...
        {
            var detalles = db.Detalles.Include(d => d.Factura);
        ...
        public ActionResult Create([Bind(Include = "detalleId,articulo,cantidad,monto,facturaId")] Detalle detalle)
        {
            if (ModelState.IsValid)
            {
                detalle.detalleId = Guid.NewGuid();
                db.Detalles.Add(detalle);
                db.SaveChanges();
                return RedirectToAction("Index");
            }

            ViewBag.facturaId = new SelectList(db.Facturas, "facturaId", "nombrecliente", detalle.facturaId);
            return View(detalle);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "detalleId,articulo,cantidad,monto,facturaId")] Detalle detalle)
        {
            if (ModelState.IsValid)
            {
